...
import { Play, Square, Trophy, Rocket, TrendingUp, Clock, Settings, ListOrdered, Copy, Check } from 'lucide-react';
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h2 style={{ fontSize: '1.4rem', fontWeight: 600, margin: 0 }}>Live Market Scanner</h2>
          </div>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>
            Iterates through all 11,000+ items to surface the highest profit arbitrage flips. 
            Runs at 1 request per second to respect API limits.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', background: 'rgba(255,255,255,0.03)', padding: '16px', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-color)', flexWrap: 'wrap', width: '100%' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }} title="Filter results by specific item quality level.">
            ...
            <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Quality</label>
            <select 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }} title="Ignore market data older than this threshold to avoid outdated prices.">
            <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Max Stale Time</label>
            <select 
              className="input-base" 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }} title="Ignore ask prices that are X times higher than the best bid (Filters out manipulated items).">
            <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Fake Order (xBid)</label>
            <input 
              type="number" 
              className="input-base" 
